...
const requests = {
    ...
    fetchHorrorMovies: `/discover/movie?api_key=${process.env.REACT_APP_API_KE}&with_genres=27`,
    fetchRomanceMovies: `/discover/movie?api_key=${process.env.REACT_APP_API_KE}&with_genres=10749`,
    fetchDocumentaries: `/discover/movie?api_key=${process.env.REACT_APP_API_KE}&with_genres=99`,
};
